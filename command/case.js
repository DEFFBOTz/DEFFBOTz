...
menuall = false
menusimpel = false
const fakeimg = fs.readFileSync ('./media/thumb.jpg')
...
module.exports = haruka = async (haruka, mek) => {
	try {
        ...
        //fake reply
			let fdoci ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `${botname} 🏟️\nBy ${ownername}`, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}},sendEphemeral: true}
...
const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
		...
		const katalog = (teks) => {
             res = haruka.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Dcode Denpa_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             haruka.relayWAMessage(res)
        }
try {
		ppmem = await haruka.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
		      } catch {
		ppmem = 'https://telegra.ph/file/f8df36078279304745bae.png'
		      }
				const ofrply = await getBuffer(ppmem)
				const pporigi = fs.readFileSync('./media/thumb.jpg')
...
haruka.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:ftrol})
break
case 'menu':
        case 'help':
        if(menusimpel == false){
...
fill =`Hai Kak ${pushname}, Selamat ${salam}
...
┗━━━━━━━━━━━>
Silahkan Pilih Button Dibawah Untuk Menampilkan Menu`
menu =`Deffri Gans`
gbutsan = [
...
mhan = await haruka.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
...
haruka.sendMessage(from, btnmenu, MessageType.buttonsMessage, {contextInfo :{text: 'hi',
...
"mediaType": "2",
"mediaUrl": "https://youtu.be/NheMc3v8xng",
"thumbnail": pporigi,
},mentionedJid:[stod]}, quoted : ftrol})
}
else if(menusimpel = true){
        stod = `${sender}`
       stst = await haruka.getStatus(`${sender.split('@')[0]}@c.us`)
...
break
case 'allmenu': 
				sendButLocation(from, lang.allmenu(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'groupmenu': 
				sendButLocation(from, lang.gc(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'textpromenu': 
				sendButLocation(from, lang.makert(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'photomakermenu': 
				sendButLocation(from, lang.makerp(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'downloadmenu': 
				sendButLocation(from, lang.download(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'hewanmenu': 
				sendButLocation(from, lang.hewan(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'islamicmenu': 
				sendButLocation(from, lang.islam(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'soundmenu': 
				sendButLocation(from, lang.sound(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'educationmenu': 
case 'edukasimenu': 
				sendButLocation(from, lang.edukasi(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'convertmenu': 
				sendButLocation(from, lang.convert(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'infobot':
...
break
case 'ownermenu': 
				sendButLocation(from, lang.own(prefix, salam, pushname), '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'owner':{
...
const skuygelud = {
    contentText: `${anu}`,
    footerText: '*_©Deffri Gans_*',
    buttons: buttons,
    headerType: 1
}
await haruka.sendMessage(from, skuygelud, MessageType.buttonsMessage, {quoted: ftrol})
}
break
...
//══════════[ ANIMASI HEWAN ]════════════════════════════//
                   ...
                   buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `OWNER`},type:1},{buttonId:`.fox`,buttonText:{displayText:'NEXT'},type:1}]
                   haruka.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu`, quoted: fdoc})
                   break
                   case 'dog':  
                   reply(lang.wait())
...
case 'bc': case 'broadcast':
			...
			var bcnya3 = await haruka.downloadMediaMessage(bcnya2)
					for (let _ of bcnya) {
						...
						for (let _ of bcnya) {
							sendButLocation(_.jid, '「 PESAN SIARAN 」\n\n' + q, '© ' + ownername, thumbnail, [{buttonId: '${prefix}owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '${prefix}infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
							}
						reply('Sukses broadcast')
					}
					break      
